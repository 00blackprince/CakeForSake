...
<?php
  ...
  <link rel="icon" href="image/cakelogo.jpg" type="image/jpg" size = "45x45"> 
  ...
  if(!(isset($_SESSION['user_login']))){ ?>
    <li class=" menu__item"><a class="menu__link" href="about.php">About</a></li>
         <?php  }else{ ?>
                   ...
                   <li class=" menu__item"><a class="menu__link" href="account.php"><?php   echo $_SESSION['name'];
; ?></a></li>
  <?php   }?>
                         ...
                         <div class="agile_inner_drop_nav_info">
                           ...
                           <div class="col-sm-3 multi-gd-img">
                             <ul class="multi-column-dropdown">
                               ...
                               <li><a href="product.php?type=Desserts">Desserts</a></li>
                               </ul>
                         </div>
                            <div class="col-sm-3 multi-gd-img">
                             <ul class="multi-column-dropdown">
                         ...
                         <div class="agile_inner_drop_nav_info">
                           <div class="col-sm-3 multi-gd-img">
                             <ul class="multi-column-dropdown">
                               ...
                               <li><a href="occassion.php?type=Photo-Cake/Theme-Cake">Photo-Cake and Theme-Cake </a></li>
